#ifndef SDCARD_SDCARD_H
#define SDCARD_SDCARD_H
...
#define SD_CMD_SD_APP_SET_WR_BLK_ERASE_COUNT       ((uint8_t)23) /* Add new */
...
// define token
#define SD_TOKEN_STARTBLK_WRITE_SINGGLE (0xFE)
#define SD_TOKEN_STARTBLK_WRITE_MULTI   (0xFC)
